...
function Home() {
    ...
    const { categoryId, detailcategoryId } = useParams<{ categoryId: string; detailcategoryId: string }>();
    ...
    const fetchCourses = async () => {
        try {
            const response = await axios.get<Course[]>(`http://localhost:5000/api/couses/${categoryId}/${detailcategoryId}`);
